...
- The GPT-5.5 RAG-generation audit has only a compact 2-person pilot plus three 10-call cache-fill batches; do not report generation metrics unless the full live run is explicitly approved and verified.
