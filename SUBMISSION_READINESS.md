...
- Main claim verifier: `checks=482 failures=0`.
...
- RAG-generation completion has five extra 10-call batches cached; the 12-person T3 stress audit is 60/60 cached, and the remaining-call budget is empty.
...
- The GPT-5.5 RAG-generation audit is fully cached on synthetic T3 records; report it as a time-stamped stress audit, not as the main reproducible evidence.
