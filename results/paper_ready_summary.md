...
- This validates the compact RAG-generation protocol only; the 12-person audit still has 30 pending calls and is not a paper claim.
...
- Claim verifier checks: 447.
- Claim verifier failures: 0.
- Full report: `results/claim_verification.md`.

## API Accounting

- Cached API responses: 645.
- Total cached token usage: 592738 input, 120526 output, 713264 total.
...
- Optional GPT-5.5 RAG-generation plan remains at 30/60 cached calls.
- RAG-generation cache-fill budget: `results/openai_gpt55_rag_12t3_budget.csv`.
- Remaining RAG-generation calls are split into 3 batches of at most 10 calls (30969 estimated tokens total).
