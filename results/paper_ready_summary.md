...
- This validates the compact RAG-generation protocol only; the 12-person audit still has 20 pending calls and is not a paper claim.
...
- Claim verifier checks: 456.
- Claim verifier failures: 0.
- Full report: `results/claim_verification.md`.

## API Accounting

- Cached API responses: 655.
- Total cached token usage: 601575 input, 121934 output, 723509 total.
...
- Optional GPT-5.5 RAG-generation plan remains at 40/60 cached calls.
- RAG-generation cache-fill budget: `results/openai_gpt55_rag_12t3_budget.csv`.
- Remaining RAG-generation calls are split into 2 batches of at most 10 calls (20666 estimated tokens total).
