...
Text verbosity: `low`
Started at UTC: `2026-06-28T21:54:42+00:00`
Git commit: `110d6ca`
Persona count: 2
New API calls this run: 10
Cached calls served this run: 0
Token usage: 8809 input, 1429 output, 10238 total.
Usage CSV: `results/openai_gpt55_rag_12t3_batch05_audit_usage.csv`
...
| --------------- | - | -------- | ------------------ | ------------------ | ----------------------- | ----------------------- | ---------------------- | -------------- |
| C1 Redact       | 2 | 2        | 1.000              | 1.000              | 1.000                   | 3.000                   | 0.250                  | 0.500          |
