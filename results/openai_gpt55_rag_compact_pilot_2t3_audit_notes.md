...
Text verbosity: `low`
Started at UTC: `2026-06-28T11:50:04+00:00`
Git commit: `e928b1f`
Persona count: 2
New API calls this run: 0
Cached calls served this run: 10
Token usage: 8898 input, 1415 output, 10313 total.
Usage CSV: `results/openai_gpt55_rag_compact_pilot_2t3_audit_usage.csv`
...
| C1b Presidio    | 2 | 2        | 1.000              | 1.000              | 1.000                   | 3.000                   | 0.200                  | 0.500          |
| C4 Local        | 2 | 2        | 1.000              | 1.000              | 1.000                   | 3.000                   | 0.250                  | 0.000          |
| C5 LG           | 2 | 2        | 1.000              | 1.000              | 0.000                   | 3.000                   | 0.000                  | 1.000          |
| C6 Agg          | 2 | 2        | 1.000              | 0.000              | 0.000                   | 3.000                   | 0.000                  | 1.000          |
