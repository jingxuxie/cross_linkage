...
Text verbosity: `low`
Started at UTC: `2026-06-28T21:36:00+00:00`
Git commit: `2075009`
Persona count: 2
New API calls this run: 10
Cached calls served this run: 0
Token usage: 8902 input, 1418 output, 10320 total.
Usage CSV: `results/openai_gpt55_rag_12t3_batch02_audit_usage.csv`
...
| --------------- | - | -------- | ------------------ | ------------------ | ----------------------- | ----------------------- | ---------------------- | -------------- |
| C1 Redact       | 2 | 2        | 1.000              | 1.000              | 1.000                   | 3.000                   | 0.200                  | 0.000          |
| C1b Presidio    | 2 | 2        | 1.000              | 1.000              | 1.000                   | 3.000                   | 0.300                  | 0.000          |
| C4 Local        | 2 | 2        | 1.000              | 1.000              | 1.000                   | 3.000                   | 0.200                  | 0.000          |
| C5 LG           | 2 | 2        | 1.000              | 0.500              | 0.500                   | 3.000                   | 0.000                  | 1.000          |
| C6 Agg          | 2 | 2        | 1.000              | 0.000              | 0.000                   | 2.500                   | 0.000                  | 1.000          |
