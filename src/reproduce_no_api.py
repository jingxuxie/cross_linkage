...
def build_steps(args: argparse.Namespace) -> list[Step]:
    ...
    steps = [
        ...
        Step(
            "openai_gpt55_aux_plan_cached_only",
            python_cmd(
                env,
                "src/openai_audit.py",
                "--config",
                ...
                "aux-match",
                "--conditions",
                "c1_direct_redaction,c1b_presidio_redaction,c4_doc_local_anon,c5_linkguard,c6_aggressive_redaction",
                "--reasoning-effort",
                "none",
                "--aux-compact-output",
                "--aux-max-output-tokens",
                "400",
                "--plan-only",
            ),
            root,
        ...
        Step(
            "openai_gpt55_doclocal_plan_cached_only",
            python_cmd(
                env,
                "src/openai_audit.py",
                "--config",
                ...
                "doc-local,aux-match",
                "--conditions",
                "c1_direct_redaction,c1b_presidio_redaction,c4_doc_local_anon,c4_openai_doc_local_gpt55_24p,c5_linkguard,c6_aggressive_redaction",
                "--reasoning-effort",
                "none",
                "--aux-compact-output",
                "--aux-max-output-tokens",
