...
RUNS = [
    ...
    AuditRun(
        run_id="gpt55_rag_12t3",
        label="GPT-5.5 RAG generation 12-person audit",
        model="gpt-5.5",
        task_family="RAG generation",
        plan_path="results/openai_gpt55_rag_12t3_audit_plan.csv",
        usage_path="results/openai_gpt55_rag_12t3_audit_usage.csv",
        notes_path="results/openai_gpt55_rag_12t3_audit_notes.md",
        primary_outputs=(
        ...
        paper_claim_status="paper_facing_cached_rag_generation_stress_audit",
        boundary_note="Completed 12-person RAG-generation stress audit on synthetic T3 records.",
    ),
    AuditRun(
